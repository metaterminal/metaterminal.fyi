...
Since this is still used as an assignment in this class, I will avoid talking about many of the low-level design decisions or actual RISC-V code! But here are the broadstrokes.
...
+ I/O Controller (not pictured here): polls the input buttons and switches, and sets reserved registers based on their current values.
